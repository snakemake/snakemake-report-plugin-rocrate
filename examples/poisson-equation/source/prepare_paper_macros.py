...
PARSER.add_argument(
    "-p", "--plot-data-path", required=True, help="The path to the data for the plot over line"
)
ARGS = vars(PARSER.parse_args())


with open(ARGS["output_macro_file"], "w") as out_file, open(ARGS["macro_template_file"]) as in_file:
